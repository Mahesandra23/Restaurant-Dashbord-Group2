...
if (!isset($_SESSION['user_id']) || $_SESSION['user_role'] != 'admin') {
    echo "Anda tidak memiliki akses, mohon login terlebih dahulu. Auto redirect or follow this ";
...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['menu_image'])) {
        ...
        $temp_file = $_FILES['menu_image']['tmp_name'];
        ...
        switch ($file_ext) {
            ...
            case 'bmp':
            case 'gif':
                move_uploaded_file($temp_file, "storage/{$filename}");
                break;
            default:
                $error = "Anda hanya bisa upload file gambar.";
                break;
        }
    } else {
        $filename = "";
    }
    $sql = "INSERT INTO menu (nama_menu, jenis, harga, deskripsi, menu_image) VALUES (?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssss", $nama_menu, $jenis, $harga, $deskripsi, $filename);
    if ($stmt->execute()) {
...
<body>
    ...
    <div class="container mx-auto login-signup isi">
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <button type="submit" value="submit" class="btn btn-primary mb-3" name="submit">Tambah Menu</button>
        </form>
    </div>
    <br>
    <br>
    <div class="container mx auto menu-list">
        <h2>Menu List</h2>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    foreach ($menu_data as $menu) {
                        ...
                        echo "<td>" . $menu['jenis'] . "</td>";
                        echo "<td>" . $menu['nama_menu'] . "</td>";
                        echo "<td>" . $menu['harga'] . "</td>";
                        echo "<td>" . $menu['deskripsi'] . "</td>";
                        echo "<td><img src='storage/{$menu['menu_image']}' width='100'></td>";
                        echo "<td>
