...
<div class="area">
    ...
    <form class="mx-auto login-signup" action="proses_login.php" method="post">
        ...
        <div class="mb-3">
            <input type="text" class="captcha " name="captcha" value="<?php echo substr(uniqid(), 5); ?>"> <br> <br>
            <label for="password" class="form-label">Type the word above:</label>
            <input class="form-control" type="text" name="confirmcaptcha" placeholder="Captcha" value=""> <br>
        </div>
        <div id="emailHelp" class="form-text mt-3">Not a member? <a href="signup.php">Sign Up</a></div>
