...
<body>
    ...
    <div class="area">
        ...
        <div class="container py-5 ">
            <h1 class="text-center text-white font-shadow mt-5">Menu</h1>
            <div class="container-xxl py-5">
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.1s">
                    <ul class="nav nav-pills d-inline-flex justify-content-center  mb-5" style="border-radius: 20px;">
                        <li class="nav-item">
                            <a class="d-flex text-decoration-none align-items-center  mx-3 pe-3 pb-3 active" data-bs-toggle="pill" href="#tab-1">
                                <i class="fa fa-coffee fa-2x text-primary"></i>
                                <div class="ps-3">
                                    <h6 class="text-white font-shadow mt-n1 mb-0">Food</h6>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="d-flex text-decoration-none align-items-center  mx-3 pb-3 pe-3" data-bs-toggle="pill" href="#tab-2">
                                <i class="fa fa-hamburger fa-2x text-primary"></i>
                                <div class="ps-3">
                                    <h6 class="text-white font-shadow mt-n1 mb-0">Dessert</h6>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="d-flex text-decoration-none align-items-center  mx-3 me-2 pb-3 pe-3" data-bs-toggle="pill" href="#tab-3">
                                <i class="fa fa-utensils fa-2x text-primary"></i>
                                <div class="ps-3">
                                    <h6 class="text-white font-shadow mt-n1 mb-0">Drink</h6>
                                </div>
                            </a>
                        </li>
                    </ul>
                                ...
                                ?>
                                        <div class="col">
                                            <div class="card shadow" style="color: black;">
                                                <a class="text-decoration-none" data-bs-toggle="collapse" data-bs-target="#descPrice<?php echo $row['id_menu']; ?>" style="cursor: pointer; color:black;">
                                                    <img width="400" height="300" src="storage/<?php echo $row['menu_image']; ?>" class="card-img-top" alt="..." style="object-fit: cover;">
                                                    <div class="card-body">
                                                        <h5 class="card-title text-black"><?php echo $row['nama_menu']; ?></h5>

                                                </a>
                                            </div>
                                            <div class="collapse" id="descPrice<?php echo $row['id_menu']; ?>">
                                                <div class="card-body">
                                                    <p class="card-text fst-italic"><?php echo $row['deskripsi']; ?></p>
                                                    <h5>Price: Rp <?php echo $row['harga']; ?></h5>
                                                </div>
                                            </div>
                                            <div class="mb-5 d-flex justify-content-around">
                                                <form method="POST" action="order.php">
                                                    <input type="hidden" name="menu_id" value="<?php echo $row['id_menu']; ?>">
